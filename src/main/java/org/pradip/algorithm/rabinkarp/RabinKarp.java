 ...
 * uses hashing to find match with pattern and character array
 * also uses rolling hash function to recalculate hash function
 */
public class RabinKarp {
     ...
     * nin = 3
     * 8 - 3 = 5
     * At the 5th element, we don't need to go further
     *
     * @param array
     * @param pattern
     * @return
